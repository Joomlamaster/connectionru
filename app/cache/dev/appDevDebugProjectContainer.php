...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->parameters = array(
            ...
            'kernel.bundles' => array(
                ...
                'ConnectionCoreBundle' => 'Connection\\CoreBundle\\ConnectionCoreBundle',
                'ConnectionWebBundle' => 'Connection\\WebBundle\\ConnectionWebBundle',
                'ConnectionUserBundle' => 'Connection\\UserBundle\\ConnectionUserBundle',
                'ConnectionEventBundle' => 'Connection\\EventBundle\\ConnectionEventBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'FOSMessageBundle' => 'FOS\\MessageBundle\\FOSMessageBundle',
                'OneupUploaderBundle' => 'Oneup\\UploaderBundle\\OneupUploaderBundle',
                'ConnectionMessageBundle' => 'Connection\\MessageBundle\\ConnectionMessageBundle',
                'ConnectionAdminBundle' => 'Connection\\AdminBundle\\ConnectionAdminBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'connectionru',
            'database_user' => 'connectionru',
            'database_password' => 'oR4phaax',
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'developer.optimum@gmail.com',
            'mailer_password' => 'OptimumDev12',
            'locale' => 'en',
            'secret' => 'ThisTokenIsNotSoSecretChangeIt',
            'facebook.appid' => '1587917454781906',
            'facebook.secret' => 'a5ac7cb4023ee1d3ba63904d26f62fc6',
            'twitter.key' => 'yWH87mrc1pETeR49y97MileCd',
            'twitter.secret' => '9m5DqquPbP52Hxklx23Oxm8HQLHirFT6H1gbT63vOfgpdWjGAV',
            'search.user.per_page' => 20,
            'search.event.per_page' => 12,
            'search.event.top.per_page' => 6,
            'event.upcoming.block.limit' => 3,
            'profile_country_iso' => array(
                0 => 'US',
                1 => 'CA',
                2 => 'UK',
                3 => 'IT',
            ...
            'ivy_league_afirmative_id' => 1,
            'quick_registration_ethnicity_id' => 8,
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'developer.optimum@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'OptimumDev12',
            ...
            'doctrine_migrations.dir_name' => (dirname(dirname(__DIR__)).'/DoctrineMigrations'),
            ...
            'fos_user.model.user.class' => 'Connection\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'webmaster@connectionru.com' => 'ConnectionRu.com',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'connection_user_registration',
            ...
            'fos_message.message_meta_class' => 'Connection\\MessageBundle\\Entity\\MessageMetadata',
            'fos_message.thread_meta_class' => 'Connection\\MessageBundle\\Entity\\ThreadMetadata',
            'fos_message.message_class' => 'Connection\\MessageBundle\\Entity\\Message',
            'fos_message.thread_class' => 'Connection\\MessageBundle\\Entity\\Thread',
            ...
            'oneup_uploader.config.user' => array(
                'storage' => array(
                    'directory' => (dirname(dirname(__DIR__)).'/../web/uploads/user/profile'),
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
            ...
            'oneup_uploader.config.event' => array(
                'storage' => array(
                    'directory' => (dirname(dirname(__DIR__)).'/../web/uploads/user/event'),
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
            ...
            'oneup_uploader.config.admin' => array(
                'storage' => array(
                    'directory' => (dirname(dirname(__DIR__)).'/../web/uploads/admin/background'),
                    'service' => NULL,
                    'type' => 'filesystem',
                    'filesystem' => NULL,
                    'stream_wrapper' => NULL,
            ...
            'oneup_uploader.controllers' => array(
                'user' => array(
                    0 => 'oneup_uploader.controller.user',
                    1 => array(
                        'enable_progress' => false,
                        'enable_cancelation' => false,
                        'route_prefix' => '',
                ...
                'event' => array(
                    0 => 'oneup_uploader.controller.event',
                    1 => array(
                        'enable_progress' => false,
                        'enable_cancelation' => false,
                        'route_prefix' => '',
                ...
                'admin' => array(
                    0 => 'oneup_uploader.controller.admin',
                    1 => array(
                        'enable_progress' => false,
                        'enable_cancelation' => false,
                        'route_prefix' => '',
            ...
            'gregwar_captcha.config' => array(
                ...
                'disabled' => true,
                'length' => 5,
                'font' => (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/DependencyInjection/../Generator/Font/captcha.ttf'),
                'keep_value' => false,
                'charset' => 'abcdefhjkmnprstuvwxyz23456789',
                'as_file' => false,
                'image_folder' => 'captcha',
                'web_path' => (dirname(dirname(__DIR__)).'/../web'),
                'gc_freq' => 100,
                'expiration' => 60,
            ...
            'gregwar_captcha.config.web_path' => (dirname(dirname(__DIR__)).'/../web'),
        ...
        $this->methodMap = array(
            ...
            'connection.twig.common_extension' => 'getConnection_Twig_CommonExtensionService',
            'connection.twig.social_extension' => 'getConnection_Twig_SocialExtensionService',
            'connection.web.form_extension' => 'getConnection_Web_FormExtensionService',
            'connection.web.user_extension' => 'getConnection_Web_UserExtensionService',
            'connection_event.event.type' => 'getConnectionEvent_Event_TypeService',
            'connection_user.converter' => 'getConnectionUser_ConverterService',
            'connection_user.event_images_namer' => 'getConnectionUser_EventImagesNamerService',
            'connection_user.facebook' => 'getConnectionUser_FacebookService',
            'connection_user.file.upload.listener' => 'getConnectionUser_File_Upload_ListenerService',
            'connection_user.profile.type' => 'getConnectionUser_Profile_TypeService',
            'connection_user.profile_images_namer' => 'getConnectionUser_ProfileImagesNamerService',
            'connection_user.registration.form.type' => 'getConnectionUser_Registration_Form_TypeService',
            'connection_user.search.type' => 'getConnectionUser_Search_TypeService',
            'connection_user.social.user' => 'getConnectionUser_Social_UserService',
            'connection_user.twitter' => 'getConnectionUser_TwitterService',
            ...
            'message_send_listener' => 'getMessageSendListenerService',
            ...
            'oneup_uploader.controller.admin' => 'getOneupUploader_Controller_AdminService',
            'oneup_uploader.controller.event' => 'getOneupUploader_Controller_EventService',
            'oneup_uploader.controller.user' => 'getOneupUploader_Controller_UserService',
            ...
            'oneup_uploader.storage.admin' => 'getOneupUploader_Storage_AdminService',
            'oneup_uploader.storage.event' => 'getOneupUploader_Storage_EventService',
            'oneup_uploader.storage.user' => 'getOneupUploader_Storage_UserService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ConnectionWebBundle', (dirname(dirname(__DIR__)).'/Resources/ConnectionWebBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'ConnectionWebBundle', (dirname(dirname(dirname(__DIR__))).'/src/Connection/WebBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    {
        return $this->services['captcha.type'] = new \Gregwar\CaptchaBundle\Type\CaptchaType($this->get('session'), $this->get('gregwar_captcha.generator'), $this->get('translator'), array('width' => 100, 'height' => 30, 'quality' => 60, 'text_color' => array(0 => 237, 1 => 237, 2 => 237), 'background_color' => array(0 => 77, 1 => 77, 2 => 77), 'as_url' => true, 'reload' => true, 'distortion' => false, 'disabled' => true, 'length' => 5, 'font' => (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/DependencyInjection/../Generator/Font/captcha.ttf'), 'keep_value' => false, 'charset' => 'abcdefhjkmnprstuvwxyz23456789', 'as_file' => false, 'image_folder' => 'captcha', 'web_path' => (dirname(dirname(__DIR__)).'/../web'), 'gc_freq' => 100, 'expiration' => 60, 'invalid_message' => 'Bad code value', 'bypass_code' => NULL, 'whitelist_key' => 'captcha_whitelist_key', 'humanity' => 0, 'max_front_lines' => NULL, 'max_behind_lines' => NULL, 'interpolation' => true));
    }

    /**
     * Gets the 'connection.twig.common_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\EventBundle\Twig\CommonExtension A Connection\EventBundle\Twig\CommonExtension instance.
     */
    protected function getConnection_Twig_CommonExtensionService()
    {
        return $this->services['connection.twig.common_extension'] = new \Connection\EventBundle\Twig\CommonExtension($this->get('security.context'));
    }

    /**
     * Gets the 'connection.twig.social_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\EventBundle\Twig\SocialExtension A Connection\EventBundle\Twig\SocialExtension instance.
     */
    protected function getConnection_Twig_SocialExtensionService()
    {
        return $this->services['connection.twig.social_extension'] = new \Connection\EventBundle\Twig\SocialExtension();
    }

    /**
     * Gets the 'connection.web.form_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\WebBundle\Twig\BootstrapFormExtension A Connection\WebBundle\Twig\BootstrapFormExtension instance.
     */
    protected function getConnection_Web_FormExtensionService()
    {
        return $this->services['connection.web.form_extension'] = new \Connection\WebBundle\Twig\BootstrapFormExtension();
    }

    /**
     * Gets the 'connection.web.user_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\WebBundle\Twig\UserExtension A Connection\WebBundle\Twig\UserExtension instance.
     */
    protected function getConnection_Web_UserExtensionService()
    {
        return $this->services['connection.web.user_extension'] = new \Connection\WebBundle\Twig\UserExtension($this->get('connection_user.converter'));
    }

    /**
     * Gets the 'connection_event.event.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\EventBundle\Form\EventType A Connection\EventBundle\Form\EventType instance.
     */
    protected function getConnectionEvent_Event_TypeService()
    {
        return $this->services['connection_event.event.type'] = new \Connection\EventBundle\Form\EventType(array(0 => 'US', 1 => 'CA', 2 => 'UK', 3 => 'IT', 4 => 'FR', 5 => 'DE', 6 => 'DK', 7 => 'AU', 8 => 'BR', 9 => 'RU', 10 => 'TR', 11 => 'UA', 12 => 'OTHER'));
    }

    /**
     * Gets the 'connection_user.converter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\Service\ConverterService A Connection\UserBundle\Service\ConverterService instance.
     */
    protected function getConnectionUser_ConverterService()
    {
        return $this->services['connection_user.converter'] = new \Connection\UserBundle\Service\ConverterService();
    }

    /**
     * Gets the 'connection_user.event_images_namer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\EventBundle\Service\EventImageNamer A Connection\EventBundle\Service\EventImageNamer instance.
     */
    protected function getConnectionUser_EventImagesNamerService()
    {
        return $this->services['connection_user.event_images_namer'] = new \Connection\EventBundle\Service\EventImageNamer($this);
    }

    /**
     * Gets the 'connection_user.facebook' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\Service\FacebookSdkService A Connection\UserBundle\Service\FacebookSdkService instance.
     */
    protected function getConnectionUser_FacebookService()
    {
        return $this->services['connection_user.facebook'] = new \Connection\UserBundle\Service\FacebookSdkService($this, '1587917454781906', 'a5ac7cb4023ee1d3ba63904d26f62fc6');
    }

    /**
     * Gets the 'connection_user.file.upload.listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\EventListener\FileUploadListener A Connection\UserBundle\EventListener\FileUploadListener instance.
     */
    protected function getConnectionUser_File_Upload_ListenerService()
    {
        return $this->services['connection_user.file.upload.listener'] = new \Connection\UserBundle\EventListener\FileUploadListener($this);
    }

    /**
     * Gets the 'connection_user.profile.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\Form\Type\ProfileType A Connection\UserBundle\Form\Type\ProfileType instance.
     */
    protected function getConnectionUser_Profile_TypeService()
    {
        return $this->services['connection_user.profile.type'] = new \Connection\UserBundle\Form\Type\ProfileType(array(0 => 'US', 1 => 'CA', 2 => 'UK', 3 => 'IT', 4 => 'FR', 5 => 'DE', 6 => 'DK', 7 => 'AU', 8 => 'BR', 9 => 'RU', 10 => 'TR', 11 => 'UA', 12 => 'OTHER'), $this->get('connection_user.converter'));
    }

    /**
     * Gets the 'connection_user.profile_images_namer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\Service\ProfileImageNamer A Connection\UserBundle\Service\ProfileImageNamer instance.
     */
    protected function getConnectionUser_ProfileImagesNamerService()
    {
        return $this->services['connection_user.profile_images_namer'] = new \Connection\UserBundle\Service\ProfileImageNamer($this);
    }

    /**
     * Gets the 'connection_user.registration.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\Form\Type\RegistrationType A Connection\UserBundle\Form\Type\RegistrationType instance.
     */
    protected function getConnectionUser_Registration_Form_TypeService()
    {
        return $this->services['connection_user.registration.form.type'] = new \Connection\UserBundle\Form\Type\RegistrationType($this);
    }

    /**
     * Gets the 'connection_user.search.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\Form\Type\SearchType A Connection\UserBundle\Form\Type\SearchType instance.
     */
    protected function getConnectionUser_Search_TypeService()
    {
        return $this->services['connection_user.search.type'] = new \Connection\UserBundle\Form\Type\SearchType(array(0 => 'US', 1 => 'CA', 2 => 'UK', 3 => 'IT', 4 => 'FR', 5 => 'DE', 6 => 'DK', 7 => 'AU', 8 => 'BR', 9 => 'RU', 10 => 'TR', 11 => 'UA', 12 => 'OTHER'));
    }

    /**
     * Gets the 'connection_user.social.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\Service\SocialUserService A Connection\UserBundle\Service\SocialUserService instance.
     */
    protected function getConnectionUser_Social_UserService()
    {
        return $this->services['connection_user.social.user'] = new \Connection\UserBundle\Service\SocialUserService($this);
    }

    /**
     * Gets the 'connection_user.twitter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\UserBundle\Service\TwitterSdkService A Connection\UserBundle\Service\TwitterSdkService instance.
     */
    protected function getConnectionUser_TwitterService()
    {
        return $this->services['connection_user.twitter'] = new \Connection\UserBundle\Service\TwitterSdkService($this, 'yWH87mrc1pETeR49y97MileCd', '9m5DqquPbP52Hxklx23Oxm8HQLHirFT6H1gbT63vOfgpdWjGAV');
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('oneup_uploader.post_persist', array(0 => 'connection_user.file.upload.listener', 1 => 'onUpload'), 0);
        ...
        $instance->addSubscriberService('message_send_listener', 'Connection\\MessageBundle\\EventListener\\Message');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'connectionru', 'user' => 'connectionru', 'password' => 'oR4phaax', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Connection/CoreBundle/Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'/src/Connection/WebBundle/Entity'), 2 => (dirname(dirname(dirname(__DIR__))).'/src/Connection/UserBundle/Entity'), 3 => (dirname(dirname(dirname(__DIR__))).'/src/Connection/EventBundle/Entity'), 4 => (dirname(dirname(dirname(__DIR__))).'/src/Connection/MessageBundle/Entity'), 5 => (dirname(dirname(dirname(__DIR__))).'/src/Connection/AdminBundle/Entity')));

        $c = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/config/doctrine') => 'FOS\\MessageBundle\\Entity'));
        $c->setGlobalBasename('mapping');

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'Connection\\CoreBundle\\Entity');
        $d->addDriver($b, 'Connection\\WebBundle\\Entity');
        $d->addDriver($b, 'Connection\\UserBundle\\Entity');
        $d->addDriver($b, 'Connection\\EventBundle\\Entity');
        $d->addDriver($b, 'Connection\\MessageBundle\\Entity');
        $d->addDriver($b, 'Connection\\AdminBundle\\Entity');
        $d->addDriver($c, 'FOS\\MessageBundle\\Entity');
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/Resources/config/doctrine/model') => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('ConnectionCoreBundle' => 'Connection\\CoreBundle\\Entity', 'ConnectionWebBundle' => 'Connection\\WebBundle\\Entity', 'ConnectionUserBundle' => 'Connection\\UserBundle\\Entity', 'ConnectionEventBundle' => 'Connection\\EventBundle\\Entity', 'FOSMessageBundle' => 'FOS\\MessageBundle\\Entity', 'ConnectionMessageBundle' => 'Connection\\MessageBundle\\Entity', 'ConnectionAdminBundle' => 'Connection\\AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_812e4d43ef6df6d5ce1c1d07d99547b19e1deb85833b53917f0e4bd83f4a1a38');
    ...
    {
        return $this->services['fos_message.message_manager'] = new \FOS\MessageBundle\EntityManager\MessageManager($this->get('doctrine.orm.default_entity_manager'), 'Connection\\MessageBundle\\Entity\\Message', 'Connection\\MessageBundle\\Entity\\MessageMetadata');
    }
    ...
    {
        return $this->services['fos_message.thread_manager'] = new \FOS\MessageBundle\EntityManager\ThreadManager($this->get('doctrine.orm.default_entity_manager'), 'Connection\\MessageBundle\\Entity\\Thread', 'Connection\\MessageBundle\\Entity\\ThreadMetadata', $this->get('fos_message.message_manager'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Connection\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('webmaster@connectionru.com' => 'ConnectionRu.com'), 'resetting' => array('webmaster@connectionru.com' => 'ConnectionRu.com'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Connection\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_registration_form', 'connection_user_registration', array(0 => 'Registration', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Connection\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Connection\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Connection\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['gregwar_captcha.image_file_handler'] = new \Gregwar\CaptchaBundle\Generator\ImageFileHandler('captcha', (dirname(dirname(__DIR__)).'/../web'), 100, 60);
    }
    ...
    /**
     * Gets the 'message_send_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Connection\MessageBundle\EventListener\Message A Connection\MessageBundle\EventListener\Message instance.
     */
    protected function getMessageSendListenerService()
    {
        return $this->services['message_send_listener'] = new \Connection\MessageBundle\EventListener\Message($this->get('fos_message.message_manager'), $this->get('swiftmailer.mailer.default'), array('webmaster@connectionru.com' => 'ConnectionRu.com'), $this->get('templating'), $this->get("security.context")->getToken()->getUser());
    }
    ...
    /**
     * Gets the 'oneup_uploader.controller.admin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Controller\DropzoneController A Oneup\UploaderBundle\Controller\DropzoneController instance.
     * 
     * @throws InactiveScopeException when the 'oneup_uploader.controller.admin' service is requested while the 'request' scope is not active
     */
    protected function getOneupUploader_Controller_AdminService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('oneup_uploader.controller.admin', 'request');
        }

        return $this->services['oneup_uploader.controller.admin'] = $this->scopedServices['request']['oneup_uploader.controller.admin'] = new \Oneup\UploaderBundle\Controller\DropzoneController($this, $this->get('oneup_uploader.storage.admin'), $this->get('oneup_uploader.error_handler.dropzone'), array('storage' => array('directory' => (dirname(dirname(__DIR__)).'/../web/uploads/admin/background'), 'service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'frontend' => 'dropzone', 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 2147483647, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false, 'namer' => 'oneup_uploader.namer.uniqid'), 'admin');
    }

    /**
     * Gets the 'oneup_uploader.controller.event' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Controller\DropzoneController A Oneup\UploaderBundle\Controller\DropzoneController instance.
     * 
     * @throws InactiveScopeException when the 'oneup_uploader.controller.event' service is requested while the 'request' scope is not active
     */
    protected function getOneupUploader_Controller_EventService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('oneup_uploader.controller.event', 'request');
        }

        return $this->services['oneup_uploader.controller.event'] = $this->scopedServices['request']['oneup_uploader.controller.event'] = new \Oneup\UploaderBundle\Controller\DropzoneController($this, $this->get('oneup_uploader.storage.event'), $this->get('oneup_uploader.error_handler.dropzone'), array('storage' => array('directory' => (dirname(dirname(__DIR__)).'/../web/uploads/user/event'), 'service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'frontend' => 'dropzone', 'namer' => 'connection_user.event_images_namer', 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 2147483647, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false), 'event');
    }

    /**
     * Gets the 'oneup_uploader.controller.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Controller\DropzoneController A Oneup\UploaderBundle\Controller\DropzoneController instance.
     * 
     * @throws InactiveScopeException when the 'oneup_uploader.controller.user' service is requested while the 'request' scope is not active
     */
    protected function getOneupUploader_Controller_UserService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('oneup_uploader.controller.user', 'request');
        }

        return $this->services['oneup_uploader.controller.user'] = $this->scopedServices['request']['oneup_uploader.controller.user'] = new \Oneup\UploaderBundle\Controller\DropzoneController($this, $this->get('oneup_uploader.storage.user'), $this->get('oneup_uploader.error_handler.dropzone'), array('storage' => array('directory' => (dirname(dirname(__DIR__)).'/../web/uploads/user/profile'), 'service' => NULL, 'type' => 'filesystem', 'filesystem' => NULL, 'stream_wrapper' => NULL, 'sync_buffer_size' => '100K'), 'frontend' => 'dropzone', 'namer' => 'connection_user.profile_images_namer', 'custom_frontend' => array('name' => NULL, 'class' => NULL), 'route_prefix' => '', 'allowed_mimetypes' => array(), 'disallowed_mimetypes' => array(), 'error_handler' => NULL, 'max_size' => 2147483647, 'use_orphanage' => false, 'enable_progress' => false, 'enable_cancelation' => false), 'user');
    }
    ...
    {
        return $this->services['oneup_uploader.routing.loader'] = new \Oneup\UploaderBundle\Routing\RouteLoader(array('user' => array(0 => 'oneup_uploader.controller.user', 1 => array('enable_progress' => false, 'enable_cancelation' => false, 'route_prefix' => '')), 'event' => array(0 => 'oneup_uploader.controller.event', 1 => array('enable_progress' => false, 'enable_cancelation' => false, 'route_prefix' => '')), 'admin' => array(0 => 'oneup_uploader.controller.admin', 1 => array('enable_progress' => false, 'enable_cancelation' => false, 'route_prefix' => ''))));
    }

    /**
     * Gets the 'oneup_uploader.storage.admin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOneupUploader_Storage_AdminService()
    {
        return $this->services['oneup_uploader.storage.admin'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage((dirname(dirname(__DIR__)).'/../web/uploads/admin/background'));
    }

    /**
     * Gets the 'oneup_uploader.storage.event' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage A Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage instance.
     */
    protected function getOneupUploader_Storage_EventService()
    {
        return $this->services['oneup_uploader.storage.event'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage((dirname(dirname(__DIR__)).'/../web/uploads/user/event'));
    }

    /**
     * Gets the 'oneup_uploader.storage.user' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage A Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage instance.
     */
    protected function getOneupUploader_Storage_UserService()
    {
        return $this->services['oneup_uploader.storage.user'] = new \Oneup\UploaderBundle\Uploader\Storage\FilesystemStorage((dirname(dirname(__DIR__)).'/../web/uploads/user/profile'));
    }
    ...
    {
        return $this->services['oneup_uploader.templating.uploader_helper'] = new \Oneup\UploaderBundle\Templating\Helper\UploaderHelper($this->get('router'), array('user' => 2097152, 'event' => 2097152, 'admin' => 2097152));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $o->setOptions(array('default_target_path' => '/user/search', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('cookie_lifetime' => 0, 'gc_probability' => 1), $this->get('session.handler'), $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('developer.optimum@gmail.com');
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Connection/WebBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Connection/UserBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'/src/Connection/EventBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.en.yml'), 'en', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.nl.yml'), 'nl', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.es.yml'), 'es', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.sv.yml'), 'sv', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.pl.yml'), 'pl', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.de.yml'), 'de', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.sl.yml'), 'sl', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.fr.yml'), 'fr', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/translations/FOSMessageBundle.ru.yml'), 'ru', 'FOSMessageBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/oneup/uploader-bundle/Oneup/UploaderBundle/Resources/translations/OneupUploaderBundle.en.yml'), 'en', 'OneupUploaderBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Connection/MessageBundle/Resources/translations/MessageBundle.en.yml'), 'en', 'MessageBundle');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'/src/Connection/AdminBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.en.yml'), 'en', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.es.yml'), 'es', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.de.yml'), 'de', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.en.yml'), 'en', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.zh_CN.yml'), 'zh_CN', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.it.yml'), 'it', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.ru.yml'), 'ru', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.uk.yml'), 'uk', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.bg.yml'), 'bg', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.ro.yml'), 'ro', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.pt_BR.yml'), 'pt_BR', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.nl.yml'), 'nl', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.es.yml'), 'es', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.zh_CN.yml'), 'zh_CN', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.it.yml'), 'it', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.ru.yml'), 'ru', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.cs.yml'), 'cs', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.cs.yml'), 'cs', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.fr.yml'), 'fr', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.ro.yml'), 'ro', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.pl.yml'), 'pl', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.fr.yml'), 'fr', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.pt_BR.yml'), 'pt_BR', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.pl.yml'), 'pl', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.nl.yml'), 'nl', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.bg.yml'), 'bg', 'validators');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/gregwar_captcha.de.yml'), 'de', 'gregwar_captcha');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/translations/validators.uk.yml'), 'uk', 'validators');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'ConnectionWebBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
        $instance->addExtension(new \Doctrine\Bundle\DoctrineBundle\Twig\DoctrineExtension());
        $instance->addExtension($this->get('connection.web.user_extension'));
        $instance->addExtension($this->get('connection.web.form_extension'));
        $instance->addExtension($this->get('connection.twig.social_extension'));
        $instance->addExtension($this->get('connection.twig.common_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Connection/WebBundle/Resources/views'), 'ConnectionWeb');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Connection/UserBundle/Resources/views'), 'ConnectionUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Connection/EventBundle/Resources/views'), 'ConnectionEvent');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/views'), 'FOSMessage');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Connection/MessageBundle/Resources/views'), 'ConnectionMessage');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Connection/AdminBundle/Resources/views'), 'ConnectionAdmin');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/gregwar/captcha-bundle/Gregwar/CaptchaBundle/Resources/views'), 'GregwarCaptcha');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => (dirname(dirname(dirname(__DIR__))).'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'), 1 => (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/Resources/config/validation.xml'), 2 => (dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/message-bundle/FOS/MessageBundle/Resources/config/validation.xml')));
    ...
    /**
     * Gets the 'oneup_uploader.error_handler.dropzone' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
    ...
    {
        return $this->services['oneup_uploader.error_handler.dropzone'] = new \Oneup\UploaderBundle\Uploader\ErrorHandler\NoopErrorHandler();
    }
