    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        if ((!$this->env->getExtension('security')->isGranted("ROLE_USER"))) {
            ...
            echo "                        <div class=\"tab-pane\" id=\"registration\">
                            ";
            // line 25
            echo twig_include($this->env, $context, "FOSUserBundle:Registration:register_content.html.twig", array("form" => (isset($context["registrationForm"]) ? $context["registrationForm"] : $this->getContext($context, "registrationForm"))));
            echo "
        ...
        echo "                    <div class=\"tab-pane active\" id=\"search\">
                        ";
        // line 30
        echo twig_include($this->env, $context, "ConnectionUserBundle:Search:quick.html.twig", array("form" => (isset($context["searchForm"]) ? $context["searchForm"] : $this->getContext($context, "searchForm"))));
        echo "
                    </div>
                </div>
            </div>
