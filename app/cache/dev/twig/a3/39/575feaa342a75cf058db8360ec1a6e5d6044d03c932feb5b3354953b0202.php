...
class __TwigTemplate_a339575feaa342a75cf058db8360ec1a6e5d6044d03c932feb5b3354953b0202 extends Twig_Template
{
    ...
    ";
        // line 3
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), 'form_start', array("action" => $this->env->getExtension('routing')->getPath("connection_tell_a_friend"), "attr" => array("role" => "form")));
        echo "
