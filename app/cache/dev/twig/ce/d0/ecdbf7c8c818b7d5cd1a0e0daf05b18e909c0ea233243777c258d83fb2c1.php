...
";
    ...
    ";
        // line 25
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), 'form_start', array("action" => $this->env->getExtension('routing')->getPath("event_manage", array("id" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")))), "attr" => array("class" => "fos_user_registration_register master_slave gmap event")));
        echo "
        <div class=\"row\">
        ...
        echo "
                ";
        // line 30
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "eventDate", array()), 'row', array("attr" => array("class" => "datepicker input-append date")));
        echo "
            </div>
            <div class=\"col-xs-3\">
        ...
        echo "                </div>
            ...
            <div class=\"col-xs-3\">
                ";
        // line 45
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "contactName", array()), 'row');
        echo "
                ";
        // line 46
...
";
                ...
                <div class=\"clearfix form-inline\">
                    <div class=\"fm-show-popup\" data-target_popup=\"profile-image\">
                        <div id=\"add-photo\">
                            ";
        // line 53
        if (($this->getAttribute($this->getAttribute((isset($context["event"]) ? $context["event"] : null), "image", array(), "any", false, true), "path", array(), "any", true, true) && (!twig_test_empty($this->getAttribute($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "image", array()), "path", array()))))) {
            // line 54
            echo "                                <img class=\"img-rounded\" width=\"140px\" height=\"190\" src=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["event"]) ? $context["event"] : $this->getContext($context, "event")), "image", array()), "path", array()), "html", null, true);
            echo "\">
                            ";
        } else {
            // line 56
        ...
        echo "
                ";
        // line 70
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "venue", array()), 'row');
        echo "
            </div>
            <div class=\"col-xs-6\">
                ";
        ...
        <div class=\"row\">
            ...
            <div class=\"col-xs-3\">
                ";
        // line 88
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "save", array()), 'row', array("attr" => array("class" => "btn-gradient")));
        echo "
            </div>
...
";
    ...
    <script type=\"text/javascript\">
        ...
        echo "\"
            ...
            \$('#";
        // line 120
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : $this->getContext($context, "form")), "eventDate", array()), "vars", array()), "id", array()), "html", null, true);
        echo "').datepicker({
                dateFormat: \"mm/dd/yy\"
            });
