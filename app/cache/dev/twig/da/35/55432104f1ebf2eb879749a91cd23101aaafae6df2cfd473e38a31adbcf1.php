    ...
    public function block_content($context, array $blocks = array())
    {
            ...
            <div class=\"col-xs-4 col-md-2\">
                <div class=\"fm-show-popup\" data-target_popup=\"profile-image\">
                    <div id=\"add-photo\">
                        ";
        // line 28
        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "user", array(), "any", false, true), "profile", array(), "any", false, true), "avatar", array(), "any", true, true) && (!twig_test_empty($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "profile", array()), "avatar", array()))))) {
            // line 29
            echo "                            <img class=\"img-rounded\" width=\"140px\" height=\"190\" src=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "profile", array()), "avatar", array()), "html", null, true);
            echo "\">
                        ";
        } else {
            // line 31
        ...
        echo "                    </div>
                ...
                <div class=\"text-center profile-image-buttons\">
                    <div class=\"profile-image-button\">
                        ";
        // line 40
        if ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : $this->getContext($context, "app")), "user", array()), "profile", array()), "hasAvatar", array())) {
            // line 41
        ...
        echo "                    </div>
            ...
            <div class=\"col-xs-8 col-md-10\">
                <ul id=\"myTab\" class=\"nav nav-tabs\" role=\"tablist\">
                    ...
                    ";
        // line 52
        if ((array_key_exists("favorites", $context) && (!twig_test_empty((isset($context["favorites"]) ? $context["favorites"] : $this->getContext($context, "favorites")))))) {
            // line 53
                ...
                <div id=\"myTabContent\" class=\"tab-content\">
                    <div role=\"tabpanel\" class=\"tab-pane active\" id=\"profile\">
                        <div class=\"col-xs-10\">
                            ";
        // line 63
        if ((array_key_exists("editPersonalInfo", $context) && (isset($context["editPersonalInfo"]) ? $context["editPersonalInfo"] : $this->getContext($context, "editPersonalInfo")))) {
            // line 64
            echo "                                ";
        ...
        echo "                        </div>
                    ...
                    <div role=\"tabpanel\" class=\"tab-pane\" id=\"gallery\">
                        ";
        // line 72
        echo twig_include($this->env, $context, "ConnectionUserBundle:Profile/Part/Edit:gallery.html.twig", array("userPhotos" => (isset($context["userPhotos"]) ? $context["userPhotos"] : $this->getContext($context, "userPhotos"))));
        echo "
                    </div>
                    ";
        // line 74
        if ((array_key_exists("favorites", $context) && (!twig_test_empty((isset($context["favorites"]) ? $context["favorites"] : $this->getContext($context, "favorites")))))) {
            ...
            echo "                        <div role=\"tabpanel\" class=\"tab-pane\" id=\"favorites\">
                            ";
            // line 76
            echo twig_include($this->env, $context, "ConnectionUserBundle:Profile/Part/Edit:favorites.html.twig", array("favorites" => (isset($context["favorites"]) ? $context["favorites"] : $this->getContext($context, "favorites"))));
            echo "
                        </div>
                    ";
        }
...
";
    ...
    <script type=\"text/javascript\">
        ...
        // line 129
        echo "        ";
        if (((isset($context["tab"]) ? $context["tab"] : $this->getContext($context, "tab")) && (!twig_test_empty((isset($context["tab"]) ? $context["tab"] : $this->getContext($context, "tab")))))) {
            // line 130
            echo "            \$(function(){
                \$(\"#myTab a[href=#";
            // line 131
