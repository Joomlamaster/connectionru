...
namespace Proxies\__CG__\Connection\AdminBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Background extends \Connection\AdminBundle\Entity\Background implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Connection\\AdminBundle\\Entity\\Background' . "\0" . 'id', '' . "\0" . 'Connection\\AdminBundle\\Entity\\Background' . "\0" . 'name', '' . "\0" . 'Connection\\AdminBundle\\Entity\\Background' . "\0" . 'path', '' . "\0" . 'Connection\\AdminBundle\\Entity\\Background' . "\0" . 'isDefault');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Background $proxy) {
