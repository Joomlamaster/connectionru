 ...
 */
class State extends \Connection\CoreBundle\Entity\State implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Connection\\CoreBundle\\Entity\\State' . "\0" . 'id', '' . "\0" . 'Connection\\CoreBundle\\Entity\\State' . "\0" . 'country', '' . "\0" . 'Connection\\CoreBundle\\Entity\\State' . "\0" . 'name', '' . "\0" . 'Connection\\CoreBundle\\Entity\\State' . "\0" . 'timezone', '' . "\0" . 'Connection\\CoreBundle\\Entity\\State' . "\0" . 'profile', '' . "\0" . 'Connection\\CoreBundle\\Entity\\State' . "\0" . 'event', '' . "\0" . 'Connection\\CoreBundle\\Entity\\State' . "\0" . 'priority');
        }
