 ...
 */
class EventComment extends \Connection\EventBundle\Entity\EventComment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Connection\\EventBundle\\Entity\\EventComment' . "\0" . 'id', '' . "\0" . 'Connection\\EventBundle\\Entity\\EventComment' . "\0" . 'author', '' . "\0" . 'Connection\\EventBundle\\Entity\\EventComment' . "\0" . 'comment', '' . "\0" . 'Connection\\EventBundle\\Entity\\EventComment' . "\0" . 'createdAt', '' . "\0" . 'Connection\\EventBundle\\Entity\\EventComment' . "\0" . 'event');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventComment $proxy) {
