    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "        <div class=\"row\">
            <div class=\"col-xs-2\">
                <div id=\"add-photo\">
                    ";
        // line 21
        if (($this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "profile", array(), "any", false, true), "avatar", array(), "any", true, true) && (!twig_test_empty($this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "profile", array()), "avatar", array()))))) {
            // line 22
            echo "                        <img class=\"img-rounded\" width=\"140\" height=\"190\" src=\"";
            echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "profile", array()), "avatar", array()), "html", null, true);
            echo "\">
                    ";
        } else {
            // line 24
        ...
        echo "                </div>
                <div class=\"text-center profile-image-buttons\">
                    ";
        // line 30
        echo twig_include($this->env, $context, "ConnectionUserBundle:Profile/Part/View:action_buttons.html.twig", array("user" => (isset($context["user"]) ? $context["user"] : null)));
        echo "
                </div>
            </div>
            <div class=\"col-xs-10\">
        ...
        if ((array_key_exists("userPhotos", $context) && (!twig_test_empty((isset($context["userPhotos"]) ? $context["userPhotos"] : null))))) {
            ...
            echo "                        <div class=\"tab-pane\" id=\"gallery\">
                            ";
            // line 50
            echo twig_include($this->env, $context, "ConnectionUserBundle:Profile/Part/View:gallery.html.twig", array("userPhotos" => (isset($context["userPhotos"]) ? $context["userPhotos"] : null)));
            echo "
                        </div>
                    ";
        }
