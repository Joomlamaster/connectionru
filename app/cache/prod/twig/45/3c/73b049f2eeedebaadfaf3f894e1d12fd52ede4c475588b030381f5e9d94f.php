...
<p>";
        // line 7
        echo $this->env->getExtension('translator')->getTranslator()->transChoice("threads_found", twig_length_filter($this->env, (isset($context["threads"]) ? $context["threads"] : null)), array("%num%" => twig_length_filter($this->env, (isset($context["threads"]) ? $context["threads"] : null))), "MessageBundle");
        // line 9
        echo "</p>
