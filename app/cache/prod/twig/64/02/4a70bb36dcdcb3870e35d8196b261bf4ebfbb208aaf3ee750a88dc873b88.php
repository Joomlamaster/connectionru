...
class __TwigTemplate_64024a70bb36dcdcb3870e35d8196b261bf4ebfbb208aaf3ee750a88dc873b88 extends Twig_Template
{
    ...
    {
        // line 1
        if ((array_key_exists("background", $context) && (!twig_test_empty((isset($context["background"]) ? $context["background"] : null))))) {
            // line 2
            echo "<div class=\"jumbotron\" style=\"background: url('";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["background"]) ? $context["background"] : null), "path", array()), "html", null, true);
