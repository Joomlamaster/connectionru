...
class __TwigTemplate_9de8fc3bddba9012c3e1a8986ca7ead403e6be7228729cf1927d260f6420f31d extends Twig_Template
{
    ...
    <div class=\"author\"><a href=\"#\">";
        // line 2
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["comment"]) ? $context["comment"] : null), "author", array()), "username", array()), "html", null, true);
        echo " | ";
    ...
    <div class=\"content\">";
        // line 3
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["comment"]) ? $context["comment"] : null), "comment", array()), "html", null, true);
        echo "</div>
</div>";
    }
