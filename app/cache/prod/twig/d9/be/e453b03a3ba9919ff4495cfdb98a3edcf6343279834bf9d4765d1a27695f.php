...
class __TwigTemplate_d9bee453b03a3ba9919ff4495cfdb98a3edcf6343279834bf9d4765d1a27695f extends Twig_Template
{
    ...
    {
        // line 2
        $this->env->getExtension('form')->renderer->setTheme((isset($context["form"]) ? $context["form"] : null), array(0 => "ConnectionUserBundle:Search:fields.html.twig"));
...
";
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        <li class=\"";
        // line 22
        if ((twig_test_empty($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "searchType", array()), "vars", array()), "data", array())) || ($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "searchType", array()), "vars", array()), "data", array()) == "quick"))) {
            echo "active";
        }
        echo "\">
        ...
        <li class=\"";
        // line 25
        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "searchType", array()), "vars", array()), "data", array()) == "extended")) {
            echo "active";
        }
        echo "\">
    ...
    ";
        // line 32
        echo "    ";
        echo         $this->env->getExtension('form')->renderer->renderBlock((isset($context["form"]) ? $context["form"] : null), 'form_start', array("action" => $this->env->getExtension('routing')->getPath("user_search"), "attr" => array("class" => "search-result master_slave", "id" => "search-form")));
        echo "
                ...
                <div class=\"col-xs-3\">
                    <div class=\"form-inline\">
                        <div class=\"row\">
                            ";
        // line 42
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "gender", array()), 'row', array("attr" => array("class" => "radio-inline gender")));
        echo "
                        </div>
                        <div class=\"row\">
                            ";
        // line 45
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "seek", array()), 'row', array("attr" => array("class" => "radio-inline seek")));
        echo "
                        </div>
                    </div>
                </div>
                <div class=\"col-xs-3\">
                    <div class=\"row\" style=\"margin-left:-30px;margin-top:-5px;\">
                        <div class=\"col-xs-6\">
                            ";
        // line 52
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "ageFrom", array()), 'row', array("attr" => array("class" => "select-inline selectpicker", "data-width" => "110px"), "label" => "Age from"));
        echo "
                        </div>
                        <div class=\"col-xs-6\" style=\"margin-left:-8px;\">
                            ";
        // line 55
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "ageTo", array()), 'row', array("attr" => array("class" => "select-inline selectpicker", "data-width" => "110px"), "label" => "to"));
        echo "
                        </div>
                    </div>
                    <div class=\"row\">
                        ";
        // line 59
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "lookingFor", array()), 'row', array("attr" => array("class" => "select-inline selectpicker", "title" => "Anything")));
        echo "
                    </div>
                </div>
                <div class=\"col-xs-6\">
                        ...
                        <div class=\"form-inline\">
                            <div class=\"row\">
                                <div style=\"margin-left:12px;\">
                                    ";
        // line 83
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "languages", array()), 'label');
        echo "
                                </div>
                                <div>
                                    ";
        // line 86
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "languages", array()), 'widget', array("attr" => array("class" => "select-inline")));
        echo "
                                </div>
                            </div>
                        </div>
...
\t\t\t\t\t\t\t";
        // line 102
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "education", array()), 'row', array("attr" => array("class" => "select-inline selectpicker", "data-selected-text-format" => "count>2")));
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div  class=\"row\">
\t\t\t\t\t\t\t";
        // line 105
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "educationIvyLeague", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
\t\t\t\t\t\t</div>
                        <div class=\"row\">
                            ";
        // line 108
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "haveChildren", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
                        <div class=\"row\">
                            ";
        // line 111
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "wantChildren", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
                        <div class=\"row\">
                            ";
        // line 114
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "openToPersonWithKids", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t";
        // line 117
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "smoking", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
\t\t\t\t\t\t</div>
                    </div>
                </div>
...
\t\t\t\t\t\t\t";
        // line 124
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "maritalStatus", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t";
        // line 127
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "minimumHeight", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
\t\t\t\t\t\t</div>
\t\t\t\t\t\t<div class=\"row\">
\t\t\t\t\t\t\t";
        // line 130
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "bodyType", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
\t\t\t\t\t\t</div>
                        <div class=\"row\">
                            ";
        // line 133
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "eyeColor", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
                        <div class=\"row\">
                            ";
        // line 136
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "hairColor", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
                        <div class=\"row\">
                            ";
        // line 139
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "drinking", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
                    </div>
                </div>
...
\t\t\t\t\t\t\t";
        // line 146
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "profession", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
\t\t\t\t\t\t</div>
                        <div class=\"row\">
                            ";
        // line 149
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "income", array()), 'row', array("attr" => array("class" => "inline-labels selectpicker")));
        echo "
                        </div>
                        <div class=\"row\">
                            ";
        // line 152
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "religion", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
                        <div class=\"row\">
                            ";
        // line 155
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "ethnicity", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
                        <div class=\"row\">
                            ";
        // line 158
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "zodiac", array()), 'row', array("attr" => array("class" => "select-inline selectpicker")));
        echo "
                        </div>
                    </div>
                </div>
            ...
            ";
        // line 164
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "searchType", array()), 'row', array("attr" => array("class" => "search-type")));
        echo "
        </div>
        <div class=\"row\">
...
\t\t\t\t\t\t\t\t\t";
        ...
        ";
        // line 250
        if ((array_key_exists("nextPage", $context) && (isset($context["nextPage"]) ? $context["nextPage"] : null))) {
            // line 251
            echo "            <a class=\"btn btn-info pull-right\" href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("user_search", array("page" => (isset($context["nextPage"]) ? $context["nextPage"] : null))), "html", null, true);
            echo "\">Next Page</a>
        ";
        }
        // line 253
