...
namespace Connection\UserBundle\Library\Facebook;
...
abstract class BaseFacebook
{
    ...
    public function getLoginUrl($params=array()) {
        ...
        return $this->getUrl(
            ...
            array_merge(
                array(
                    'client_id' => $this->getAppId(),
                    'redirect_uri' => (!empty($this->loginReirectUrl) ? $this->loginReirectUrl : $currentUrl), // possibly overwritten
                    'state' => $this->state,
    ...
    /**
     * @param mixed $loginReirectUrl
     */
    public function setLoginRedirectUrl ( $loginReirectUrl )
    {
        $this->loginReirectUrl = $loginReirectUrl;
    }
